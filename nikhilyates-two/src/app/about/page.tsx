...
const About = () => {
    ...
    return (
        <div id='about' className='bg-zinc-950 h-auto min-h-screen p-16 flex flex-col justify-start gap-8'>
            <h1 className='scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-8xl text-zinc-500 leading-10'><span className='text-white'>nikhil yates</span> is a <span className='text-white'>
